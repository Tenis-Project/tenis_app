                                        ...
                                        builder: (BuildContext context) {
                                            return AlertDialog(
                                                ...
                                                content: const SingleChildScrollView(
                                                    ...
                                                    'reservar canchas de tenis en nuestras instalaciones. El servicio incluye la selección de la cancha, la fecha y hora de '
                                                    ...
                                                    '6. Cancelaciones y Modificaciones Las cancelaciones o modificaciones de las reservas pueden realizarse hasta 24 horas antes '
                                                    'de la hora programada. No se aceptarán cancelaciones ni modificaciones después de este plazo.\n'
                                                    '7. Uso de las Instalaciones Los usuarios deben cumplir con las normas de conducta y vestimenta adecuadas para el uso de las '
                                                    'instalaciones. La empresa se reserva el derecho de negar el acceso a cualquier usuario que no cumpla con estas normas.\n'
                                                    '8. Limitación de Responsabilidad La empresa no será responsable de ningún daño o pérdida que pueda sufrir como resultado del '
                                                    ...
                                                    '11. Contacto Si tiene alguna pregunta o inquietud sobre estos términos, póngase en contacto con nosotros a través de la información '
                                                    'de contacto proporcionada en la aplicación.\n'),
                                                ),
                                                actions: <Widget>[
                                                    TextButton(
                                                        child: const Text(
